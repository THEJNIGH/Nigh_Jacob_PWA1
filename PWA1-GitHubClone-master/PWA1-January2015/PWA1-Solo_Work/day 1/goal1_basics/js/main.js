 ...
 ********************************************/
    ...
    var total = numbers[0] + numbers[1] + numbers[2] + numbers[3];
    console.log("The total of the numbers are " + total + ".");
 ...
 ********************************************/
    ...
    theArray[0] = "Baseball";
    theArray[1] = "Football";
    theArray[2] = "Basketball";
    console.log(theArray[0] + theArray[1] + theArray[2]);
 ...
 ********************************************/
    ...
    var weather = "Cloudy";
    if (weather == "Sunny") {
        console.log("Bobs mood is happy");
    }
    else {
        console.log("Bobs mood is sad");
    }
...
/*
    ...
    var waves = 10;
    if (weather === "Sunny") {
        console.log("Bobs mood is ");
    }
        if (weather === "Sunny" && waves === 10)
        {
            console.log("Bobs mood is pumped")
        }
        else if (weather === "Sunny" && waves <= 9 && waves >= 5)
        {
            console.log("Bobs mood is mellow")
        }
        else if (weather === "Sunny" && waves <= 5)
        {
            console.log("Bobs mood is bumbed")
        }
        else if (weather === "overcast" && waves <= 10 && waves >= 7 )
        {
            console.log("Bobs mood is jacked up")
        }
        else if (weather === "overcast" && waves <= 6 && waves >= 3)
        {
            console.log("Bobs mood is totally bumbed")
        }
        else if (weather == "overcast" && waves <= 2)
        {
            console.log("Bobs mood is not happy")
        }
    else {
        console.log("Bobs mood is sad");
    }
