...
// Array - For Loop
	...
	for(var  i = 0, x = students1.length; i < x; i++)
	{
		console.log("The name of the student is " + students1[i] + " and the index number is " + i);
	}
...
*/
	...
	var firstName = "James";
	var nameFunction = function(var1)
	{
		var firstName = var1;
		var lastName = "Bond";
	...
	var fullName = nameFunction(firstName);
...
*******************************************************************************/  
 //--------------------------------------------------------
    console.log("4. sentence char count");
        ...
        var charCount = function(newct)
		{
				var myArray = newct.split(" ");
				return [myArray, myArray.length];
		}
		var temp = charCount("Im a little tea cup short and stout, here is my handle here is my spout");
		console.log(temp);	
