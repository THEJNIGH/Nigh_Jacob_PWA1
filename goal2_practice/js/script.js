...
/*
	...
	functionNAME(arguments); //function call and arguments
	...
	var results = functionNAME(arguments);
...
console.log('------ MORE Booleans ----------');
    ...
    if (num)
    {
        console.log("Its true", num);
    }
    else
    {
	console.log("Its false", num);
    }
/*
	===============================================
	MORE:  Arrays
 ...
 ********************************************/
    ...
    all = combined.concat(secondHalfYr);
    console.log(all);
